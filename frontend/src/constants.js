...
import CavsLogo from './logos/Cavs.png';
...
import MavsLogo from './logos/MavericksLogo.png';
...
import PortlandLogo from './logos/Portland.png';
...
export const nwe = 'Patriots';
export const nyj = 'Jets';
export const cin = 'Bengals';
export const cle = 'Browns';
export const pit = 'Steelers';
export const rav = 'Ravens';
export const clt = 'Colts';
export const htx = 'Texans';
export const jax = 'Jaguars';
export const oti = 'Titans';
export const den = 'Broncos';
export const kan = 'Chiefs';
export const rai = 'Raiders';
export const sdg = 'Chargers';

export const dal = 'Cowboys';
export const nyg = 'Giants';
export const phi = 'Eagles';
export const was = 'Washington';
export const chi = 'Bears';
export const det = 'Lions';
export const gnb = 'Packers';
export const min = 'Vikings';
export const atl = 'Falcons';
export const car = 'Panthers';
export const nor = 'Saints';
export const tam = 'Buccaneers';
export const crd = 'Cardinals';
export const ram = 'Rams';
export const sea = 'Seahawks';
export const sfo = '49ers';
...
export const nbaTeamLogos = {
  'Milwaukee Bucks': BucksLogo,
  'Chicago Bulls': BullsLogo,
  'Cleveland Cavaliers': CavsLogo,
  'Boston Celtics': CelticsLogo,
  'Los Angeles Clippers': ClippersLogo,
  'Memphis Grizzlies': GrizzliesLogo,
  'Atlanta Hawks': HawksLogo,
  'Miami Heat': HeatLogo,
  'Charlotte Hornets': HornetsLogo,
  'Utah Jazz': JazzLogo,
  'Sacramento Kings': KingsLogo,
  'New York Knicks': KnicksLogo,
  'Los Angeles Lakers': LakersLogo,
  'Orlando Magic': MagicLogo,
  'Dallas Mavericks': MavsLogo,
  'Brooklyn Nets': NetsLogo,
  'Denver Nuggets': NuggetsLogo,
  'Indiana Pacers': PacersLogo,
  'New Orleans Pelicans': PelicansLogo,
  'Philadelphia 76ers': PhiLogo,
  'Detroit Pistons': PistonsLogo,
  'Portland Trail Blazers': PortlandLogo,
  'Toronto Raptors': RaptorsLogo,
  'Houston Rockets': RocketsLogo,
  'San Antonio Spurs': SpursLogo,
  'Phoenix Suns': SunsLogo,
  'Oklahoma City Thunder': ThunderLogo,
  'Minnesota Timberwolves': TimberwolvesLogo,
...
export const nbaFullNamesToShortNames = {
  'Milwaukee Bucks': 'MIL',
  'Chicago Bulls': 'CHI',
